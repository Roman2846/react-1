  ...
  return (
    <Page>
      ...
      <Amenities
        ...
        hasFree={data.amenities.hasFreeBreakfast}
        hasFreeWiFi={data.amenities.hasFreeWiFi}
        hasParking={data.amenities.hasParking}
        hasPets={data.amenities.hasPetsAllowed}
        hasAirport={data.amenities.hasAirportShuttle}
        hasConcierge={data.amenities.hasConciergeService}
        hasRoom={data.amenities.hasRoomService}
        hasChild={data.amenities.hasChildFriendly}
      />
      ...
      <Properties
        ...
        instructions={data.additional_properties.check_instructions}
      />

      <Reviews comment={data.guestReviews} />
